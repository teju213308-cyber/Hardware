...
localparam  [ 6: 0] LUI     = 7'b0110111,        // U-type
                    ...
                    ARITHR  = 7'b0110011,        // R-type (OP)
                    OP_M    = 7'b0110011,        // RV32M alias
                    CUSTOM_0 = 7'b0001011;       // MAU Custom

localparam  [ 6: 0] RV32M_FUNCT7 = 7'b0000001;   // RV32M and MAU Funct7
